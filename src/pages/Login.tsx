  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background px-4 dark">
      <div className="w-full max-w-sm">
        ...
        <Button variant="outline" className="w-full mb-6 h-11 border-border/50 text-foreground hover:bg-secondary/50" onClick={() => navigate("/dashboard")}>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <Input id="email" type="email" value={email} onChange={e => setEmail(e.target.value)} className="mt-1 bg-secondary/30 border-border/50 text-foreground" placeholder="you@example.com" />
          </div>
          <div>
            <Label htmlFor="password" className="text-sm text-foreground">Password</Label>
            <Input id="password" type="password" value={password} onChange={e => setPassword(e.target.value)} className="mt-1 bg-secondary/30 border-border/50 text-foreground" placeholder="••••••••" />
          </div>
